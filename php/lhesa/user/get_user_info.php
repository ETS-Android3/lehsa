<?php
	...
	function get_user_info(array $request)
    {
		$user_name = $request['user_name'];
		log_message("Requesting user info for the user '".$user_name."'");
		$sql = "SELECT first_name, last_name FROM student_details WHERE user_name = ?";
